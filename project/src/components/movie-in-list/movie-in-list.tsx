...
function MovieInList({films, film, handleClick}: MovieInListProps): JSX.Element {
  const {
    background,
    poster,
    title,
  ...
  const raitingTitle = generateRatingTitle(rating);
            ...
            <div className="film-card__desc">
              ...
              <div className="film-rating">
                ...
                <p className="film-rating__meta">
                  <span className="film-rating__level">{raitingTitle}</span>
